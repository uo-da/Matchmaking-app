...
describe('matchUtils', () => {
  const users = [
    { id: 'user-1', displayName: 'A', age: 28, gender: '男性', stackTags: ['React', 'Node.js'], experienceYears: 3, matches: ['user-2'] },
    { id: 'user-2', displayName: 'B', age: 32, gender: '女性', stackTags: ['Python'], experienceYears: 5, matches: ['user-1'] },
    { id: 'user-3', displayName: 'C', age: 24, gender: '女性', stackTags: ['React'], experienceYears: 1, matches: [] }
  ];
